...
function getDefinicoes(quadro) {
    ...
    let data = [
        ...
        },
        {
            ...
            quadro: 4,
            description: 'Um estudo observacional prospectivo, com objetivo de estimar o risco específico do paciente EP nas 19-24 semanas de gestação por fatores maternos e combinações de PAM, UtA-PI, fator PLGF e tirosina quinase-1 solúvel em soro do tipo sérica (sFlt-1). Com base no risco de EP, as mulheres seriam estratificadas em grupos de gerenciamento de alto, intermediário e baixo risco. O grupo de alto risco exigiria um monitoramento cuidadoso da pressão alta e da proteinúria entre 24 e 31 semanas. O grupo de risco intermediário, juntamente com as gestações não entregues do grupo de alto risco, teria uma reavaliação do risco de EP em 32 semanas para identificar aqueles que precisariam de monitoramento próximo da pressão arterial alta e proteinúria em 32-35 semanas. Os riscos específicos do paciente ao parto com EP com <32 e <36 semanas de gestação foram calculados usando o modelo de riscos concorrentes para combinar a distribuição anterior da idade gestacional no parto com PE, obtida a partir das características maternas e do histórico médico, com múltiplos de os valores medianos (MoM) de MAP, UtA-PI, PlGF e sFlt-1. A população estudada de 16 254 gestações únicas incluiu 467 (2,9%) que desenvolveram EP subsequentemente (23 entregues em <32 semanas, 58 entregues em 32 + 0 a 35 + 6 semanas e 386 entregues em ≥ 36 semanas). Usando um risco de> 1 em 25 para EP com <32 semanas de gestação e risco de> 1 em 150 para EP com <36 semanas, a proporção da população estratificada no grupo de alto risco foi de cerca de 1% do total, e a proporção de casos de EP com <32 semanas de gestação contidos nesse grupo de alto risco variou de cerca de 35% com triagem por fatores maternos e PAM, a 78% com fatores maternos, PAM e UtA-PI e até 100 % com fatores maternos, PAM, UtA-PI e PlGF, com ou sem sFlt-1. Da mesma forma, a proporção da população que requer reavaliação de risco em 32 semanas. Concluíram que na nova pirâmide de cuidados com a gravidez, a avaliação do risco de EP nas 19-24 semanas de gestação pode estratificar a população naqueles que necessitam de monitoramento intensivo nas 24-31 semanas e naqueles que necessitam de reavaliação às 32 semanas.',
            link: 'https://pubmed.ncbi.nlm.nih.gov/29943498/'
        },
        {
            name: '30 a 34 semanas', 
            quadro: 4,
            description: 'Um estudo observacional prospectivo, com objetivo de estimar o risco específico da paciente com EP entre 30 e 34 semanas de gestação por uma combinação de características maternas e histórico médico com múltiplos dos valores medianos (MoM) da PAM, UtA-PI, PLGF e sFlt-1 e estratificam as mulheres em grupos de manejo de alto, intermediário e baixo risco. Os riscos específicos da paciente ao parto com EP com menos de 4 semanas da avaliação e com menos de 40 semanas de gestação foram calculados usando o modelo de riscos competitivos para combinar o risco anterior de características maternas e histórico médico com os valores MoM de MAP, UtA-PI, PlGF e sFlt-1. Com base nesses riscos, a população foi estratificada em grupos de alto, intermediário e baixo risco. A população estudada de 8128 gestações únicas incluiu 234 (2,9%) que subsequentemente desenvolveram EP. Usando um ponto de corte de risco de 1 em 50 para PE com menos de 4 semanas e um ponto de corte de 1 em 150 para PE com <40 semanas de gestação, a proporção da população estratificada em risco alto, intermediário e baixo foi de cerca de 3%, 26% e 71%, respectivamente. O grupo de alto risco continha 90% das gestações com PE em <4 semanas e 40% daquelas com PE em 4 semanas, desde a avaliação até a gestação de 40 semanas. O grupo de risco intermediário continha mais 49% de mulheres com PE às 4 semanas da avaliação às 40 semanas gestacionais. No grupo de baixo risco, nenhuma das mulheres desenvolveu EP em <4 semanas e apenas 0,3% desenvolveu EP em 4 semanas a 40 semanas gestacionais. Concluem que ao identificar o grupo de alto risco deve-se ter um monitoramento intensivo desde o momento da avaliação inicial e até 40 semanas de gestação e que todas as gestações precisariam ser reavaliadas com 40 semanas.',
            link: 'https://www.nejm.org/doi/full/10.1056/nejmoa1704559'
        },
        {
            name: '35 a 37 semanas', 
            quadro: 4,
            description: 'Em um estudo observacional, com objetivo de estimar o risco específico do paciente de pré-eclâmpsia (EP) nas 35-37 semanas de gestação por uma combinação de características maternas e histórico médico com múltiplos dos valores medianos (MoM) de PAM, UtA ‐ PI, PLGF e sFlt ‐ 1 e estratificam as mulheres em grupos de manejo de alto, intermediário e baixo risco.   O grupo de alto risco exigiria monitoramento intensivo desde o momento da avaliação inicial e até 40 semanas de gestação, o grupo de risco intermediário exigiria uma reavaliação com 40 semanas de gestação e o grupo de baixo risco seria gerenciado com expectativa. A população estudada de 3703 gestações únicas incluiu 38 (1,0%) com PE <40 semanas de gestação e 22 (0,6%) com PE ≥ 40 semanas. O grupo de alto risco continha 92% das gestações com PE com menos de 40 semanas de gestação e 73% daquelas com PE com ≥ 40 semanas. O grupo de risco intermediário continha mais 27% de mulheres com PE com ≥ 40 semanas. No grupo de baixo risco, nenhuma das mulheres desenvolveu EP com <40 ou ≥ 40 semanas de gestação. O grupo classificado como de alto risco para EP pode ser monitorado por medição da pressão arterial e exame de urina pelo menos semanalmente e as mulheres podem ser aconselhadas a relatar quaisquer sintomas associados à EP grave, como distúrbios visuais e dor epigástrica. O grupo de risco intermediário exige reavaliação com 40 semanas de gestação, mas essas mulheres também seriam aconselhadas a relatar quaisquer sintomas associados à EP grave. O grupo de baixo risco pode ter certeza de que o desenvolvimento de EP é muito improvável e, na ausência de achados anormais de ultrassom ou outras indicações obstétricas, as gestações podem ser gerenciadas com expectativa, aguardando o início espontâneo do trabalho de parto. Os limites de risco para definir a proporção da população estratificada em cada um dos três grupos de manejo e os protocolos para esse manejo variarão inevitavelmente de acordo com as preferências locais e as considerações econômicas da saúde.',
